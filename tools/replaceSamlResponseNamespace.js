...
const replaceForSamlp = () => {
  ...
  const logoutRequestTemplatePath = path.join('node_modules', 'samlp', 'templates', 'logoutrequest.ejs');
  ...
  restoreFile(logoutRequestTemplatePath);
...
const replaceForSamlp2 = () => {
  ...
  editFile(logoutRequestTemplatePath, editTemplateForSamlNamespace, true);
